/**
 * htpasswd verification (§4b basicAuth) — pure-TS, isomorphic.
 *
 ...
 * `unsupported-hash` (reactors answer 501 with a precise body).
 */
...
/** Detected hash type label of an htpasswd entry (for precise 501 bodies). */
