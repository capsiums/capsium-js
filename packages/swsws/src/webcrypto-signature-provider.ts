 ...
 * RSASSA-PKCS1-v1_5 with SHA-256) — the browser counterpart of the
 * packager's NodeSignatureProvider. Private keys are imported as PKCS#8,
 * public keys as SPKI; X.509 certificate PEMs are NOT supported by
 * WebCrypto (use the raw public key PEM).
 */
